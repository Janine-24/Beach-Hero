...
export const cardData = [
  ...
  },
  {
    ...
    location: 'Freedom Island, Manila',
  },
  {
    ...
    location: 'Great Barrier Reef, AUS',
  },
  {
    title: 'Our Impact in One Day',
    description: 'Together, we removed over 500 pounds of debris, preventing it from entering the ocean.',
    imageAlt: 'An infographic showing the total weight of trash collected',
    titleColor: 'text-sky-800',
    imageSrc: ourImpactInOneDayImg,
    buttonText: 'Learn More',
    detailedDescription: "As the sun began to set, the mountain of filled trash bags stood in stark contrast to the newly cleaned beach. We had removed over 500 pounds of debris—a weight equivalent to a grand piano. It's 500 pounds of plastic that won't be ingested by a sea turtle, 500 pounds of waste that won't break down into microplastics, and a clear message that a single day of focused effort can make a monumental difference.",
    location: 'Serendipity Beach, Cambodia',
  },
  {
  ...
  },
  {
    ...
    location: 'Future Generations',
  },
  {
    title: 'Every Piece Counts',
    description: 'Even the smallest piece of litter removed makes a big impact.',
    imageAlt: 'Close-up of a hand holding a single piece of recovered litter',
    titleColor: 'text-sky-800',
    imageSrc: everyPieceCountsImg,
    buttonText: 'Learn More',
    detailedDescription: "Holding a single, weathered piece of plastic in your hand, you can't help but think about its journey. Where did it come from? How long has it been in the ocean? Removing it feels like a small act of redemption, a way of correcting a past mistake. It's a tangible connection to a global problem and a personal reminder that individual choices, both good and bad, have a real impact.",
    location: 'Individual Action',
  },
];
...
const Action = () => {
  ...
  return (
    <div className="bg-sky-50 py-16 md:py-24 overflow-hidden">
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex overflow-x-auto gap-8 py-4 scroll-smooth scrollbar-hide action-scroll-container">
          {cardData.map((card, index) => {
            const isExpanded = selectedCardTitle === card.title;
            return (
              <article 
                key={index} 
                className={`bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl cursor-pointer w-[320px] flex-shrink-0 flex flex-col ${isExpanded ? 'border-2 border-teal-500' : ''}`}
              ...
              >
                ...
                <div className="relative">
                  ...
                  />
                  <div className="absolute bottom-0 left-0 bg-black bg-opacity-50 text-white text-sm font-semibold px-3 py-1 rounded-tr-lg">
                    {card.location}
                  </div>
                </div>
                  ...
                  {!isExpanded && (
                    <div className="mt-4 text-center">
                      <button
                        ...
                        className="inline-block bg-sky-600 text-white font-bold text-sm uppercase tracking-wider px-6 py-3 rounded-full shadow-md hover:bg-sky-700 hover:shadow-lg transition-all duration-300"
                      >
                        {card.buttonText}
                      </button>
                    </div>
                    ...
                    <div className="overflow-hidden">
                      ...
                      <div className="mt-4 text-center">
                         <button
                            ...
                            className="inline-block bg-teal-600 text-white font-bold text-sm uppercase tracking-wider px-6 py-3 rounded-full shadow-md hover:bg-teal-700 hover:shadow-lg transition-all duration-300"
                          >
                            Close
                          </button>
                      </div>
