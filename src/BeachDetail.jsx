  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="h-screen relative w-full">
        ...
        <a href="#real-cases" className="absolute bottom-10 left-1/2 -translate-x-1/2 text-white animate-bounce cursor-pointer hover:text-teal-200 transition">
          ↓ Scroll for Details
        </a>
      </div>
      ...
      <div id="real-cases" className="max-w-4xl mx-auto px-6 py-24">
        <div className="prose prose-lg text-gray-600 leading-relaxed mx-auto">
          ...
          <h3 className="text-3xl font-bold text-teal-800 mb-8 border-b border-teal-100 pb-4">
            The Environmental Impact
          </h3>

          {/* Intro Paragraph */}
          <p className="text-xl mb-8">
             <span className="font-bold text-teal-700 mr-2">{beach.name}:</span>
             {beach.content.intro} 
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 my-12">
            ...
            {/* Marine Life Card */}
            <div className="bg-sand-50 p-6 rounded-2xl border border-orange-100">
              <span className="text-4xl">🐠</span>
              <h4 className="font-bold text-xl mt-4 mb-2 text-slate-800">Marine Life</h4>
            ...
            <div className="bg-sand-50 p-6 rounded-2xl border border-orange-100">
              <span className="text-4xl">📉</span>
              <h4 className="font-bold text-xl mt-4 mb-2 text-slate-800">Economic Loss</h4>
            ...
            <div className="bg-sand-50 p-6 rounded-2xl border border-orange-100">
              ...
              <h4 className="font-bold text-xl mt-4 mb-2 text-slate-800">Habitat Destruction</h4>
