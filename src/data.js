...
export const SITE_DATA = {
  ...
  beaches: [
    // 1. INDONESIA 
    {
      ...
      // Added stats for WasteChart
      stats: [
        { label: 'Plastic Wrappers', value: 65, color: '#ef4444' }, 
        { label: 'Fabric/Textile', value: 15, color: '#f59e0b' },   
        { label: 'Rubber', value: 10, color: '#3b82f6' },  
        { label: 'Wood/Organic', value: 10, color: '#22c55e' }, 
      ],
    ...
    // 2. PHILIPPINES
    {
      ...
      // Added stats for WasteChart
      stats: [
        { label: 'Single-use Sachets', value: 54, color: '#ef4444' }, 
        { label: 'Plastic Bottles', value: 20, color: '#f59e0b' },   
        { label: 'Hard Plastics', value: 15, color: '#3b82f6' },  
        { label: 'Other Waste', value: 11, color: '#64748b' }, 
      ],
    ...
    // 3. DOMINICAN REPUBLIC
    {
      ...
      // Added stats for WasteChart
      stats: [
        { label: 'Styrofoam', value: 45, color: '#ef4444' }, 
        { label: 'Plastic Bottles', value: 30, color: '#f59e0b' },   
        { label: 'Household Waste', value: 15, color: '#3b82f6' },  
        { label: 'Organic Matter', value: 10, color: '#22c55e' }, 
      ],
